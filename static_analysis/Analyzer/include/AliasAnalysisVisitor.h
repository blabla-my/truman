...
public:
    ...
    Function *toAnalyze, std::vector<Instruction *> *srcCallSites): currState(targetState) {
...
private:
    ...
    void handleDMAFunction(llvm::CallInst &I);

    AliasObject *getObj4Copy(PointerPointsTo *pto, StructType *ty, Instruction &I);

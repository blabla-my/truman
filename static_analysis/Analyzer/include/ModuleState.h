...
//#define DEBUG_GLOBALS
    ...
    public:
        ...
        std::set<llvm::Instruction *> dma_inst_set;

        std::set<std::tuple<Type*, FunctionArgument *, Value *, InstLoc *, PointerPointsTo *>> entry_args_set;
        ...
        static bool toCreateObjForGV(llvm::GlobalVariable *globalVariable) {
            ...
            if (dyn_cast<ArrayType>(ty)) {
                Type *ety = dyn_cast<ArrayType>(ty)->getElementType();

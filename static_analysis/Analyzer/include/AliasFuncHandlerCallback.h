...
namespace DRCHECKER {
    ...
    public:
        ...
        virtual void* handleDMAFunction(CallInst &callInst, Function *targetFunction, void *private_data);
    ...
    private:
        ...
        void* createDMAObject(CallInst &callInst, Function *targetFunction, void *private_data);

...
public:
    ...
    virtual bool is_dma_function(const Function *targetFunction)=0;
	...
	virtual ~FunctionChecker() = default;
};
...
public:
    ...
    virtual void* handleDMAFunction(CallInst &callInst, Function *targetFunction, void *private_data) = 0;
